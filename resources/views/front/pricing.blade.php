    ...
    <section class="pricing">
        <div class="center-div">
            ...
            <div class="header-button mt-5">
                <a href="free-trial.php" class="btn btn-trail">FREE TRIAL 30 DAYS <i class="fa fa-arrow-right"></i>
                </a>
                        ...
                        <div class="card pricing-card">
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0)"
                                    class="btn-getstarted btn btn-shutter-more text-uppercase bg_blue" data-toggle="modal"
                                    data-target="#exampleModalCenter1">GET STARTED</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pricing-table">
                        <div class="card pricing-card">
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0)"
                                    class="btn-getstarted btn btn-shutter-more text-uppercase bg_blue" data-toggle="modal"
                                    data-target="#exampleModalCenter2">GET STARTED</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="col-lg-12 col-sm-12 contact_form full_width_100">
                        <div class="inner_contact_row"> <br>
                            <center><img class="logo  w-100"
                                    src="{{ asset('assets/front/images/logo/footer-logo.png') }}"> </center>
