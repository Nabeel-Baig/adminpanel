...
class RoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Roles::insert([
            ['name' => 'master-admin', 'permission' => '["createUser","updateUser","viewUser","deleteUser","createRole","updateRole","viewRole","deleteRole","createCurrency","updateCurrency","viewCurrency","deleteCurrency","createCategory","updateCategory","viewCategory","deleteCategory","createProduct","updateProduct","viewProduct","deleteProduct","createTag","updateTag","viewTag","deleteTag","createBanner","updateBanner","viewBanner","deleteBanner","createPage","updatePage","viewPage","deletePage","updateSetting","updateProfile","viewContact","deleteContact"]', 'created_by' => 1, 'created_at' => $now],
